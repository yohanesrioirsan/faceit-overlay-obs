...
export default function NeoBrutalismTemplate({
  ...
  return (
    <div
      className={`px-3 p-2 text-lg border-2 border-black text-white max-w-lg rounded-lg relative overflow-hidden bg-[#FF7A05] shadow-[-2px_3px_0px_#000] ${jetbrains.className}`}
    >
